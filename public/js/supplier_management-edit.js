    ...
    $('#reg').validate({
        rules: {
            number: {
                ...
                number: true,
                remote: {
                    url: '/suppliermanagement/checkUnique',
                    type: 'POST',
                    data: {
                        number: function () {
                            return $("#number").val()
                        ...
                        id: function () {
                            return $("#suppliermanagement_id").val();
                        },
                        key: function () {
                            return 2;
                        }
        ...
        submitHandler: function (form) {
            $.ajax({
                url: '/suppliermanagement/' + $("#suppliermanagement_id").val(),
                type: 'put',
                data: {
                ...
                success: function (r, s, x) {
                    if (r == 'true') {
                        ...
                        $('#ok-text').html('数据添加成功');
                        setTimeout(function () {
                            window.location.href = "/suppliermanagement";
                        }, 100);
                    }
                }
            })
