<?php $__env->startSection('title', '销货'); ?>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        <form action="/sales" method="get" class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add sale')): ?>
                                    <a class="btn btn-info btn-sm " type="button" href="/sales/create"><i class="glyphicon glyphicon-plus"></i> 新增</a>
                                    <?php endif; ?>
                                    <a class="btn btn-info btn-sm " type="button" href="/sales/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                    <a class="btn btn-warning btn-sm " type="button" href="/sales"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                </div>
                            </div>
                        </form>
                    </div>
