<?php $__env->startSection('title', '购货收款'); ?>
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form action="/purchasereceipts" method="get" class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add purchaseReceipts')): ?>
                                    <a class="btn btn-info btn-sm " type="button" href="/purchasereceipts/create"><i class="glyphicon glyphicon-plus"></i> 付款</a>
                                    <?php endif; ?>
                                    <a class="btn btn-info btn-sm " type="button" href="/purchasereceipts/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                    <a class="btn btn-warning btn-sm " type="button" href="/purchasereceipts"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table table-striped">
                            ...
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/purchasereceipts/<?php echo e($value->id); ?>" class="btn btn-primary btn-sm " type="button"><i class="fa fa-money"></i> 查看</a>
                                    </td>
                                </tr>
