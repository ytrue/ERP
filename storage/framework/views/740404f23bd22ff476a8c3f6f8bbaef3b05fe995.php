    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/purchasepayment">销货收款 </a> /  <?php echo e($payment->ood_number); ?>  - 详情
                </h5>
                    ...
                    <div class="ibox-content" >
                        <table class="table table-bordered text-center">
                            ...
                            <div class="form-group">
                                <label class=" control-label col-sm-0" style="margin-left: -170px;">销货单位</label>
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name"  disabled="disabled" value="<?php echo e($payment->getClient->name); ?>">
                                    </div>
                                </div>
                            </div>
                            <tr>
                                <th class="text-center">销货订单</th>
                                ...
                                <tr>
                                    <td style="width: 200px;">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class=" input-group">
                                                    <?php echo e($value->getSales->document_number); ?>
