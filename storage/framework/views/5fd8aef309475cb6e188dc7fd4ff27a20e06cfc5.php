<?php $__env->startSection('title', '购货'); ?>
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form action="/purchase" method="get" class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add purchase')): ?>
                                    <a class="btn btn-info btn-sm " type="button" href="/purchase/create"><i class="glyphicon glyphicon-plus"></i> 新增</a>
                                    <?php endif; ?>
                                    <a class="btn btn-info btn-sm " type="button" href="/purchase/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                    <a class="btn btn-warning btn-sm " type="button" href="/purchase"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                </div>
                            </div>
                        </form>
                                        ...
                                        <?php
                                            ...
                                            for ($i = 0; $i <sizeof($value->getPurchaseExtend); $i++){
                                             ...
                                             if ($value->preferential_rate == 0){
                                                ...
                                                echo   sprintf("%.2f",$number*$preferential_rate);
                                             }
                                        ?>
                                    </td>
