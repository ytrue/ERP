<?php $__env->startSection('title', '供应商对账单'); ?>
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        <div>
                            <form action="/suppliers_reconciliation_new" method="get" class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <a class="btn btn-info btn-sm " type="button" href="/suppliers_reconciliation_new/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                        <a class="btn btn-warning btn-sm " type="button" href="/suppliers_reconciliation_new"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                    </div>
                                </div>
                            </form>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e($value['salesAmount']); ?></td>
                                    <td class="text-center"><?php echo e($value['wholeSingleDiscount']); ?></td>
