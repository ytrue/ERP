                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-9 m-b-xs">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add goods')): ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete goods')): ?>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status goods')): ?>
                            ...
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e($value->current_inventory); ?></td>

                                    <td class="text-center"><?php echo e($value->predicted_price); ?></td>
                                    <td class="text-center"><?php echo e($value->retail_price); ?></td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status goods')): ?>
                                    <td class="text-center"><a url="/goods/<?php echo e($value->id); ?>/status" onclick="set_status($(this).attr('url'),this)"><?php echo $value->status; ?></a></td>
                                    <?php endif; ?>
                                    <td class="text-center">
                                        <a href="/goods/<?php echo e($value->id); ?>" class="btn btn-primary btn-sm " type="button"><i class="fa fa-money"></i> 查看</a>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit goods')): ?>
                                        <a href="/goods/<?php echo e($value->id); ?>/edit" class="btn btn-success btn-sm " type="button"><i class="fa fa-paste"></i> 编辑</a>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete goods')): ?>
                                        <a class="btn btn-danger btn-sm " type="button" url="/goods/<?php echo e($value->id); ?>" onclick="jump($(this).attr('url'),<?php echo e($value->id); ?>);"><i class="glyphicon glyphicon-trash"></i> 删除</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
