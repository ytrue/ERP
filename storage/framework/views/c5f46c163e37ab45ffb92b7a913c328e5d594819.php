<?php $__env->startSection('title', '购货退货出库'); ?>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status getPurchaseReturn')): ?>
                            ...
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a url="/purchase_return_status"
                                                               onclick="set_status($(this).attr('url'),this,<?php echo e($value->id); ?>)"><?php echo $value->status; ?></a>
                                    </td>
                                    <?php endif; ?>
                                    <td class="text-center">
                                        <a href="/purchasereturns/<?php echo e($value->id); ?>" class="btn btn-primary btn-sm "
