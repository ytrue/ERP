<?php $__env->startSection('title', '销货详情'); ?>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/sales">销货管理 </a> /  <?php echo e($sales->document_number); ?>  - 详情
                </h5>
                ...
                <div    class="form-horizontal" >
                    ...
                    <div class="ibox-content" >
                        <table class="table table-bordered text-center">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name" disabled  style="width: 250px;" value="<?php echo e($sales->getClient->name); ?>" >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name" disabled  style="width: 250px;" value="<?php echo e($sales->getStaff->name); ?>" >
                                    </div>
                                </div>
                            </div>
                            <tr>
                            ...
                            <tbody id="add_row">
                            <?php $__currentLoopData = $sales->getSalesExtend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                            ...
                            <tr>
                                <th class="text-center" style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="col-sm-4">总数量：<span id="sum_number">
                                              <?php
                                                  $number = 0;
                                                  for ($i = 0; $i <sizeof($sales->getSalesExtend); $i++){
                                                       $number+=$sales->getSalesExtend[$i]->number;
                                                   }
                                                   echo $number;
                                              ?>
                                        </span>
                                    ...
                                    <div class="col-sm-4">购货总金额：<span id="sum_purchase_amount">
                                             <?php
                                                 $number = 0;
                                                 for ($i = 0; $i <sizeof($sales->getSalesExtend); $i++){
                                                      $number+=$sales->getSalesExtend[$i]->purchase_amount;
                                                  }
                                                  echo $number;
                                             ?>
                                        </span></div>
                            ...
                            <tr>
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea  class="form-control" disabled placeholder="简介..."><?php echo e($sales->details); ?></textarea>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test01"  value="<?php echo e($sales->preferential_rate); ?>" disabled>
                                            </div>
                                        </div>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test03" value="<?php echo e($sales->paid); ?>" disabled="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" disabled="disabled" value="<?php echo e($sales->getAccount->name); ?>">
                                            </div>
                                        </div>
