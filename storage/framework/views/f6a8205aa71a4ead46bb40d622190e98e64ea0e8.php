<?php $__env->startSection('title', '购货入库'); ?>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        <form action="/get_purchase" method="get" class="col-sm-12">
                            ...
                            <div class="form-group" style="width: 395px">
                                ...
                                <div>
                                    <select class="form-control m-b" name="supplierManagement">
                                        <option></option>
                                        <?php $__currentLoopData = $supplierManagement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a class="btn btn-info btn-sm " type="button" href="/get_purchase/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                    <a class="btn btn-warning btn-sm " type="button" href="/get_purchase"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status getPurchase')): ?>
                            ...
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e($value->getSupplierManagement->name); ?></td>

                                    <td class="text-center">
                                        <?php
                                            $number = 0;
                                            for ($i = 0; $i <sizeof($value->getPurchaseExtend); $i++){
                                                 $number+=$value->getPurchaseExtend[$i]->purchase_amount;
                                             }
                                             echo $number;
                                        ?>
                                    </td>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status getPurchase')): ?>
                                    <td class="text-center"><a url="/purchase_status" onclick="set_status($(this).attr('url'),this,<?php echo e($value->id); ?>)"><?php echo $value->status; ?></a></td>
                                    <?php endif; ?>
                                    <td class="text-center">
                                        <a href="/purchase/<?php echo e($value->id); ?>" class="btn btn-primary btn-sm " type="button"><i class="fa fa-money"></i> 查看</a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
