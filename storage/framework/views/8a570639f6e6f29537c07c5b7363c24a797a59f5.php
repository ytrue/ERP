<?php $__env->startSection('title', '销货退货订单详情'); ?>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/salereturn">销货退货订单 </a> /  <?php echo e($sale_return->document_number); ?>  - 详情
                </h5>
                ...
                <div    class="form-horizontal" >
                    ...
                    <div class="ibox-content" >
                        <table class="table table-bordered text-center">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name" disabled  style="width: 250px;" value="<?php echo e($sale_return->getClient->name); ?>" >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name" disabled  style="width: 250px;" value="<?php echo e($sale_return->getStaff->name); ?>" >
                                    </div>
                                </div>
                            </div>
                            <tr>
                            ...
                            <tbody id="add_row">
                            <?php $__currentLoopData = $sale_return->getSaleReturnExtend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                            ...
                            <tr>
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea  class="form-control" disabled placeholder="简介..."><?php echo e($sale_return->details); ?></textarea>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test01"  value="<?php echo e($sale_return->preferential_rate); ?>" disabled>
                                            </div>
                                        </div>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test03" value="<?php echo e($sale_return->paid); ?>" disabled="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" disabled="disabled" value="<?php echo e($sale_return->getAccount->name); ?>">
                                            </div>
                                        </div>
