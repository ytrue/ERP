<?php $__env->startSection('title', '客户订单出库'); ?>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        <form action="/get_sales" method="get" class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a class="btn btn-info btn-sm " type="button" href="/get_sales/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                    <a class="btn btn-warning btn-sm " type="button" href="/get_sales"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="text-center">已收款</th>
                                <th class="text-center">收款状态</th>
                                <th class="text-center">制单人</th>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status getSales')): ?>
                            ...
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                            ...
                                            for ($i = 0; $i <sizeof($value->getSalesExtend); $i++){
                                                 $number+=$value->getSalesExtend[$i]->purchase_amount;
                                             }
                                             echo $number;
                                        ?>
                                    </td>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status getSales')): ?>
                                    <td class="text-center"><a url="/sales_status" onclick="set_status($(this).attr('url'),this,<?php echo e($value->id); ?>)"><?php echo $value->status; ?></a></td>
                                    <?php endif; ?>
                                    <td class="text-center">
                                        <a href="/sales/<?php echo e($value->id); ?>" class="btn btn-primary btn-sm " type="button"><i class="fa fa-money"></i> 查看</a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
