        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        <div>
                            <form action="/account_pay_detail_new" method="get" class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <a class="btn btn-info btn-sm " type="button" href="/account_pay_detail_new/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                        <a class="btn btn-warning btn-sm " type="button" href="/account_pay_detail_new"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                    </div>
                                </div>
                            </form>
