                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key => $value)
                                <tr>
                                    ...
                                    @can('status getPurchase')
                                    <td class="text-center"><a url="/purchase_status" onclick="set_status($(this).attr('url'),this,{{$value->id}})">{!!$value->status !!}</a></td>
                                    @endcan
                                    <td class="text-center">
                                        <a href="/purchase/{{$value->id}}" class="btn btn-primary btn-sm " type="button"><i class="fa fa-money"></i> 查看</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
