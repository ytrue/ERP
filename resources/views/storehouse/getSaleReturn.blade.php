                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($model as $key => $value)
                                <tr>
                                    ...
                                    @can('status getSaleReturn')
                                    <td class="text-center"><a url="/sale_return_status" onclick="set_status($(this).attr('url'),this,{{$value->id}})">{!!$value->status !!}</a></td>
                                    @endcan
                                    <td class="text-center">
