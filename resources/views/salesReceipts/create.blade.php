                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content"  style="width: 750px;">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"> <span class="glyphicon glyphicon-plus"> 选择关联销货单位</span>  </h4>
                        </div>
                        <!-- 主体 -->
                            ...
                            <div class="form-horizontal">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr >
                                        ...
                                        <th  class="text-center">选择销货单位</th>
                                    </tr>
                                    </thead>
                ...
                <div    class="form-horizontal" >
                    ...
                    <div class="ibox-content" >
                        <table class="table table-bordered text-center">
                            <thead>
                            <div class="form-group">
                                <label class=" control-label col-sm-0">：销货单位</label>
                                <div class="col-sm-3">
...
@section('extend-js')
    <script src="../js/salesReceipts.js"></script>
@endsection
