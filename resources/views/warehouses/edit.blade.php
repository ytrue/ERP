    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/warehouse">仓库管理 </a> / {{$warehouse->name}} - 修改
                </h5>
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal"  action="/warehouse/{{$warehouse->id}}" id="reg">
                    {{method_field("PUT")}}
                    {{csrf_field()}}
                    <input type="hidden" value="{{$warehouse->id}}" id="warehouse_id" name="id">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">仓库编号</label>

                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="number" id="number" value="{{$warehouse->number}}">
                        </div>
                    </div>
