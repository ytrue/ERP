        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <div class="ibox-content">
                    <div class="row">
                        <div>
                            <form action="/procurement_summary_supplier" method="get" class="col-sm-12">
                                ...
                                <div class="form-group" style="width: 395px">
                                    ...
                                    <div>
                                        <select class="form-control m-b" name="supplierManagement">
                                            <option></option>
                                            @foreach($supplierManagement as $value)
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <a class="btn btn-info btn-sm " type="button" href="/procurement_summary_supplier/excel"><i class="glyphicon glyphicon-share"></i> 导出Excel</a>
                                        <a class="btn btn-warning btn-sm " type="button" href="/procurement_summary_supplier"><i class="glyphicon glyphicon-refresh"></i>  重置 / 刷新</a>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            @foreach($model as $value)
                                <tr>
                                    <td class="text-center">{{$value['supplierManagement']}}</td>
