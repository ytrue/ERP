    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/purchase">购货管理 </a> /  {{$purchase->document_number}}  - 详情
                </h5>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name" disabled  style="width: 250px;" value="{{$purchase->getSupplierManagement->name}}" >
                                    </div>
                                </div>
                            </div>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea  class="form-control" disabled placeholder="简介...">{{$purchase->details}}</textarea>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test01"  value="{{$purchase->preferential_rate}}" disabled>
                                            </div>
                                        </div>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test03" value="{{$purchase->paid}}" disabled="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" disabled="disabled" value="{{$purchase->getAccount->name}}">
                                            </div>
                                        </div>
