    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/supplier">供应商类别 </a> / {{$supplier->name}} - 修改
                </h5>
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal"  action="/supplier/{{$supplier->id}}" id="reg">
                    {{method_field("PUT")}}
                    {{csrf_field()}}
                    <input type="hidden" value="{{$supplier->id}}" id="supplier_id" name="id">
