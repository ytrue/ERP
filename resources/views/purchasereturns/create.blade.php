    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/purchasereturns">购货退货 </a> /  新增退货
                </h5>
                    ...
                    <div class="modal-content"  style="width: 750px;">
                        ...
                        <div class="modal-body" style="overflow: auto;max-height: 550px;" >
                            <div class="form-horizontal">
                                ...
                                <div>
                                    <ul class="pager" count="{{$supplierManagement->count()}}" id="pages-client">
                            ...
                            <div class="form-horizontal">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tr >
                                        ...
                                        <th  class="text-center">当前仓库库存总数量</th>
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tr>
                                <th class="text-center" style="width: 55px;"colspan="9" rowspan="1">
                                    ...
                                    <div class="col-sm-4">退货总金额：<span id="sum_purchase_amount"></span></div>
                                </th>
                            </tr>
                            <tr>
...
@section('extend-js')
    <script src="../js/purchasereturns.js"></script>
@endsection
