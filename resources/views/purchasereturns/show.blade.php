    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/purchasereturn">购货退货管理 </a> /  {{$purchasereturn->document_number}}  - 详情
                </h5>
                ...
                <div    class="form-horizontal" >
                    ...
                    <div class="ibox-content" >
                        <table class="table table-bordered text-center">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    <div class=" input-group">
                                        <input type="text" class="form-control " id="gys_name" disabled  style="width: 250px;" value="{{$purchasereturn->getSupplierManagement->name}}" >
                                    </div>
                                </div>
                            </div>
                            <tr>
                            ...
                            <tbody id="add_row">
                            @foreach($purchasereturn->getPurchasereturnExtend as $key => $value)
                                <tr>
                            ...
                            <tr>
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea  class="form-control" disabled placeholder="简介...">{{$purchasereturn->details}}</textarea>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test01"  value="{{$purchasereturn->preferential_rate}}" disabled>
                                            </div>
                                        </div>
                                ...
                                <td style="width: 55px;"colspan="9" rowspan="1">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="test03" value="{{$purchasereturn->paid}}" disabled="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" disabled="disabled" value="{{$purchasereturn->getAccount->name}}">
                                            </div>
                                        </div>
