    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><a href="/customer">客户类型 </a> / {{$customer->name}} - 修改
                </h5>
            ...
            <div class="ibox-content">
                <form method="post" class="form-horizontal"  action="/customer/{{$customer->id}}" id="reg">
                    {{method_field("PUT")}}
                    {{csrf_field()}}
                    <input type="hidden" value="{{$customer->id}}" id="customer_id" name="id">
